	...
	while (i!=0) {
...

		{
			case 1:
				...
				for (int g=0; g<indice; g++){
                                strcpy(contacts[g].numero,nouveau_numero); 
				strcpy(contacts[g].email,nouveau_email);}
				break;
                        case 3:          
			        printf("\n");
				...
				break;
			        ...
			        for(int a=0;a<j;a++)
				{
                                    printf("Nom: %s, Numero: %s, Email: %s \n",contacts[a].nom,contacts[a].numero,contacts[a].email);
				    printf("\n");
				}
				break;
                         case 5:
			 ...
			 for (int e=0;e<id;e++)
			 {
                         printf("Nom: %s, Numero: %s, Email: %s \n",contacts[e].nom,contacts[e].numero,contacts[e].email);
}}}return 0;
}
